...
if __name__ == "__main__":
    ...
    for epochGAN in [10]:
        ...
        # savePath_LL_D = path_AD_autoencoder_results + "/LL_D" +  ".npy"
        savePath_LL = path_AD_autoencoder_results + "/LL" +  ".npy"
        savePath_RL = path_AD_autoencoder_results + "/RL" +  ".npy"
        savePathPlotAucRoc = settings["path_savePlotAucRoc_invert"] + "/ROC_Curve_" + str(epochGAN) + ".pdf"
        ...
        f = open(settings["path_savePlotAucRoc_invert"] + "/aucRocMaxValues.txt", "a")
        f.write("\nepochGAN: " + str(epochGAN) + "   -   aucRocMax_D: "  + str(aucRocMax_D) + ", aucRocMax_G: "  + str(aucRocMax_G) + ", aucRocMax_CombDG: "  + str(aucRocMax_CombDG))
        f.close()
